...
/**
  ...
  *
  * @checksum - 5528941fa43bb13a91cd27d82c5901f6533f3ecd993e33f2745870b4e47fdb20
  * @variables - radius=rounded-lg,accentColor=violet,colorTemperature=stone,spacing=2,scale=base,inputShadow=shadow-lg,baseColorShade=500,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:button__input": {
    ...
    "group-[]/repeater:shadow-md": true,
    "group-[]/multistep:shadow-md": true,
    "dark:border-violet-500": true
  },
  "family:box__wrapper": {
    "inline-flex": true,
    "items-center": true,
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-violet-400": true,
    "peer-checked:border-violet-500": true,
    "relative": true,
    "block": true,
    "text-lg": true,
    "w-[1em]": true,
    ...
    "peer-checked:bg-violet-50": true,
    "peer-checked:text-violet-500": true,
    ...
    "dark:ring-offset-violet-400": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-stone-600/50": true,
    "dark:peer-checked:bg-violet-800": true,
    "dark:peer-checked:text-violet-300": true
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-violet-400": true,
    "focus-within:!border-violet-400": true,
  ...
  "family:dropdown__listitem": {
    ...
    "text-stone-700": true,
    "text-base": true,
    "data-[is-active]:bg-violet-100": true,
    ...
    "data-[is-active]:before:ring-violet-400": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-violet-100": true
  },
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "cursor-pointer": true,
    "dark:text-stone-200": true,
    "dark:hover:text-violet-400": true
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-violet-400": true
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-violet-300": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-violet-500": true
  },
  "button__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
    ...
    "dark:text-violet-500": true,
    "dark:bg-transparent": true,
    "dark:hover:bg-violet-50/5": true
  },
  "checkbox__decorator": {
    "rounded": true
  },
  ...
  "date__input": {
    ...
    "selection:text-stone-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-violet-100": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-violet-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-violet-100": true
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-violet-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-violet-100": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-violet-100": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-violet-100": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-violet-100": true
  },
  "file__fileList": {
    "group/list": true,
    "peer": true,
  ...
  "file__fileRemove": {
    ...
    "peer-data-[has-multiple]:text-violet-500": true,
  ...
  "form__messageLink": {
    ...
    "group-[]/summary:ring-violet-500": true
  },
  "month__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "[&::-webkit-slider-thumb]:bg-violet-500": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-violet-400": true,
    "[&::-webkit-slider-thumb]:focus:ring-offset-2": true,
    "[&::-webkit-slider-thumb]:shadow-lg": true,
    ...
    "[&::-moz-range-thumb]:bg-violet-500": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-violet-400": true,
    "[&::-moz-range-thumb]:focus:ring-offset-2": true,
    "[&::-moz-range-thumb]:shadow-lg": true,
  ...
  "select__option": {
    ...
    "group-data-[multiple]:checked:bg-violet-100": true,
    "group-data-[multiple]:focus:bg-violet-100": true,
    ...
    "dark:group-data-[multiple]:focus:bg-violet-700": true,
    "dark:group-data-[multiple]:checked:bg-violet-700": true
  },
  "select__prefixIcon": {
    "flex": true,
    "items-center": true,
  ...
  "submit__input": {
    ...
    "bg-violet-500": true,
    "!text-white": true,
    "active:text-violet-100": true,
    "active:bg-violet-600": true,
  ...
  "week__input": {
    ...
    "selection:text-stone-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-violet-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-violet-100": true
  },
  ...
  "colorpicker__panel": {
    ...
    "group-data-[inline]:w-full": true,
    "group-data-[inline]:shadow-lg": true,
  ...
  "colorpicker__control": {
    ...
    "focus-visible:ring-violet-400": true
  },
  ...
  "colorpicker__fieldGroup": {
    ...
    "[&>input]:selection:bg-violet-100": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    ...
    "[&>input:focus]:ring-violet-500": true,
    "[&>input:focus]:border-violet-500": true,
  ...
  "colorpicker__swatch": {
    ...
    "[&>canvas:focus-visible]:ring-violet-400": true,
  ...
  "datepicker__dayCell": {
    ...
    "dark:bg-stone-600": true,
    "dark:text-stone-300": true,
    "dark:aria-selected:bg-violet-500": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-violet-500": true,
  ...
  "datepicker__timeInput": {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-violet-500": true,
    "dark:text-stone-300": true,
    "dark:bg-transparent": true,
    "dark:border-stone-600": true
  },
  ...
  "datepicker__dayButton": {
    ...
    "dark:text-stone-300": true,
    "dark:border-stone-600": true,
    "dark:hover:border-violet-400": true
  },
  ...
  "datepicker__calendarIcon": {
    "text-stone-600": true,
    "focus-visible:text-violet-500": true,
    "flex": true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  "slider__tooltip": {
    ...
    "after:border-t-violet-500": true,
  ...
  "toggle__track": {
    ...
    "transition-all": true,
    "bg-stone-400": true,
    "peer-checked:bg-violet-500": true,
    ...
    "shadow-md": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-violet-400": true,
  ...
  "togglebuttons__input": {
    ...
    "dark:disabled:text-violet-500": true,
    "dark:text-violet-500": true,
    "aria-[pressed=\"true\"]:bg-violet-500": true,
    "aria-[pressed=\"true\"]:text-white": true,
    "dark:aria-[pressed=\"true\"]:bg-violet-500": true,
    ...
    "group-data-[vertical=\"false\"]/options:group-[]/option:aria-[pressed=\"true\"]:border-x-violet-500": true,
    "group-data-[vertical=\"false\"]/options:group-first/option:aria-[pressed=\"true\"]:border-l-violet-500": true,
    "group-data-[vertical=\"false\"]/options:group-last/option:aria-[pressed=\"true\"]:border-r-violet-500": true,
    "dark:group-data-[vertical=\"false\"]/options:group-[]/option:aria-[pressed=\"true\"]:border-x-violet-500": true,
    "dark:group-data-[vertical=\"false\"]/options:group-first/option:aria-[pressed=\"true\"]:border-l-violet-500": true,
    "dark:group-data-[vertical=\"false\"]/options:group-last/option:aria-[pressed=\"true\"]:border-r-violet-500": true,
    ...
    "group-data-[vertical=\"true\"]/options:group-[]/option:aria-[pressed=\"true\"]:border-y-violet-500": true,
    "group-data-[vertical=\"true\"]/options:group-first/option:aria-[pressed=\"true\"]:border-t-violet-500": true,
    "group-data-[vertical=\"true\"]/options:group-last/option:aria-[pressed=\"true\"]:border-b-violet-500": true,
    "dark:group-data-[vertical=\"true\"]/options:group-[]/option:aria-[pressed=\"true\"]:border-y-violet-500": true,
    "dark:group-data-[vertical=\"true\"]/options:group-first/option:aria-[pressed=\"true\"]:border-t-violet-500": true,
    "dark:group-data-[vertical=\"true\"]/options:group-last/option:aria-[pressed=\"true\"]:border-b-violet-500": true
  },
  "transferlist__outer": {
    "group": true,
    "min-w-0": true,
    ...
    "text-base": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-violet-500": true,
  ...
  "transferlist__transferlist": {
    ...
    "[&:has(:focus-visible)]:ring-violet-400": true,
    "dark:border-stone-600": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "ring-1": true,
    "ring-stone-200": true,
    "aria-selected:bg-violet-100": true,
    "data-[is-active=true]:bg-violet-100": true,
    "data-[is-active=true]:ring-violet-200": true,
    "aria-selected:ring-violet-200": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-stone-800": true,
    "dark:text-stone-300": true,
    "dark:data-[is-active=true]:bg-violet-800": true,
    "dark:aria-selected:bg-violet-800": true,
    "dark:ring-stone-700": true,
    "dark:data-[is-active=true]:ring-violet-600": true,
    "dark:aria-selected:ring-violet-600": true,
    "[&.formkit-dropZone]:bg-violet-100": true,
    "[&.formkit-selectionDropZone]:bg-violet-100": true,
    "[&.formkit-touchDropZone]:bg-violet-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-violet-100": true,
    "[&.formkit-longTouch]:bg-violet-100": true,
    "dark:[&.formkit-dropZone]:bg-violet-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-violet-900": true,
    "dark:[&.formkit-touchDropZone]:bg-violet-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-violet-900": true,
    "dark:[&.formkit-longTouch]:bg-violet-900": true
  },
  ...
  "transferlist__transferlistSearch": {
    ...
    "dark:border-stone-600": true,
    "dark:text-stone-300": true,
    "dark:selection:bg-violet-100": true,
    "dark:selection:text-stone-700": true,
    "dark:bg-stone-800": true
  },
  ...
  "multi-step__wrapper": {
    "group/wrapper": true,
    "data-[tab-style=\"tab\"]:shadow-lg": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=\"progress\"]/wrapper:data-[valid=\"true\"]:data-[visited=\"true\"]:after:bg-violet-500": true,
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:data-[valid=\"true\"]:data-[visited=\"true\"]:after:bg-violet-500": true
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=\"true\"]/tab:bg-violet-500": true,
  ...
  "multi-step__steps": {
    ...
    "group-data-[tab-style=\"progress\"]/wrapper:shadow-lg": true,
